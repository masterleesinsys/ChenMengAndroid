 ...
 * 推荐课程视频
 */
public class RecommendedCourseAdapter extends RecyclerView.Adapter<RecommendedCourseAdapter.MyViewHolder> {
    private List<VideoDetailInfo> list;
    private Context context;
    private OnItemClickListener onItemClickListener;

    RecommendedCourseAdapter(List<VideoDetailInfo> list, Context context) {
        this.list = list;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_recommended_course, parent, false);
