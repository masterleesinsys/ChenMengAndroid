 ...
 * 最近更新视频
 */
public class RecenUpdatesAdapter extends RecyclerView.Adapter<RecenUpdatesAdapter.MyViewHolder> {
    private List<VideoDetailInfo> list;
    private Context context;
    private OnItemClickListener onItemClickListener;

    public RecenUpdatesAdapter(List<VideoDetailInfo> list, Context context) {
        this.list = list;
