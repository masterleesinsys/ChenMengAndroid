...
import com.wenyue.chenmeng.util.FileUtils;
import com.wenyue.chenmeng.util.ImageUtil;
...
public class MyApplication extends Application {
    public static String SERVICE_HOST = "http://00/";    //服务地址
    public static String IMAGE_HOST = "http://00";
